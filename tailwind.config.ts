  ...
  theme: {
    extend: {
      ...
      boxShadow: {
        ...
        "lime-glow": "0 4px 24px -4px rgba(45,212,191,0.35)",
      ...
      backgroundImage: {
        ...
        "radial-lime":
          "radial-gradient(ellipse 80% 60% at 50% -20%, rgba(45,212,191,0.15), transparent)",
        "radial-dark":
          "radial-gradient(ellipse 80% 60% at 50% 120%, rgba(45,212,191,0.08), transparent)",
      },
    },
  },
  plugins: [],
